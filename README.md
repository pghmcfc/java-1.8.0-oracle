...
- Click on the JDK Download button for Java SE 8u371
- You need to accept the Oracle Technology Network License Agreement for Oracle
  Java SE before continuing
- Download the Linux x86 - Compressed Binary (jdk-8u371-linux-i586.tar.gz),
  or on x86_64, the Linux x64 - Compressed Binary (jdk-8u371-linux-x64.tar.gz)
...
mock -r fedora-38-x86_64 --copyin jdk-8u371-linux-x64.tar.gz /builddir/build/SOURCES
mock --dnf -r fedora-38-x86_64 --no-clean --rebuild java-1.8.0-oracle-1.8.0.371-1.fc38.nosrc.rpm
```
