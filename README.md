...
- Click on the JDK Download button for Java SE 8u172
- Download the Linux x86 - Compressed Binary (jdk-8u172-linux-i586.tar.gz),
  or on x86_64, the Linux x64 - Compressed Binary (jdk-8u172-linux-x64.tar.gz)
